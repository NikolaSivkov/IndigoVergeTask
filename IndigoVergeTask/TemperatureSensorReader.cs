...
{
    public class TemperatureSensorReader : ISensorDataReader
    {
        public string SensorName { get; } = "Temperature";
        private readonly IModbusMaster modbusMaster;
        private readonly IAppConfig AppConfig;
        private readonly Sensor Sensor;

        public TemperatureSensorReader(IModbusMaster modbusMaster, IAppConfig appConfig)
        {
